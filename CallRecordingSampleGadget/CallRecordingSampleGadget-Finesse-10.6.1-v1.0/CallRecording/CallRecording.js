...
finesse.modules.CallRecordingGadget = (function ($) {
    ...
    _startRecordingError = function(rsp) {
		_clientLogger.log ("_startRecordingError()");
	...
	return {
		...
		startRecording : function () {
				_clientLogger.log ("startRecording()");
				
				if (_dialog === null) {
					_clientLogger.log("No Dialog to start recording on.");
					return;	//code
				}

				_clientLogger.log("Starting Recording on Dialog: " + _dialog.getId());
		...
		_clientLogger.init(gadgets.Hub, "CallRecordingGadget", finesse.gadget.Config); //this gadget id will be logged as a part of the message
