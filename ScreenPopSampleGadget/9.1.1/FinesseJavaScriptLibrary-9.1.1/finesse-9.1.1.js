...
finesse.clientservices.ClientServices = (function () {
    ...
    _becomeMaster = function () {
        ...
        _publisher = new finesse.clientservices.MasterPublisher(_tunnel);
...
finesse.restservices.RestBase = finesse.FinesseBase.extend({
    ...
    subscribe: function (callbacks) {
        ...
        handlers,
        successful = finesse.clientservices.ClientServices.subscribe(topic, this._createPubsubCallback());
        ...
        handlers = {
            success: function () {
                ...
                if (!_this.doNotRefresh) {
                    finesse.clientservices.ClientServices.addToRefreshList(_this);
                }
    ...
    unsubscribe: function (callbacks) {
        ...
        finesse.clientservices.ClientServices.removeFromRefreshList(_this);
    ...
    _subscribeNode: function (callbacks) {
        ...
        // Protect against null dereferencing of callbacks allowing its (nonexistant) keys to be read as undefined
        callbacks = callbacks || {};
