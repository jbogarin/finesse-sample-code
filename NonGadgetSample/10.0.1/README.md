...
the Cisco Ajax XMPP Library (http://developer.cisco.com/web/xmpp/resources)
to receive events. All responses and events will simply print to the debugger console.
The code has been tested with Firefox 14.0.1 and Firebug 1.10.2.
...
requests. The HTML page currently imports the library straight from a public
CDN. If access to the CDN is not available, please download the jQuery from
http://www.jquery.com
...
http://developer.cisco.com/web/xmpp/resources
...
for forwarding both BOSH and Web Service requests:
    ProxyPass /finesse http:/host:80/finesse
