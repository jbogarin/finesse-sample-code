...
gadgets.window.adjustHeight();
	...
	displayCall = function (dialog){
	    ...
	    var callVars = dialog.getMediaProperties();
		 ...
		 $("#dnis").text(dialog.getDNIS());
		 $("#callType").text(dialog.getCallType());
	...
	return {
	    ...
	    init : function () {
			...
			clientLogs.init(gadgets.Hub, "PhoneBookGadget"); //this gadget id will be logged as a part of the message
