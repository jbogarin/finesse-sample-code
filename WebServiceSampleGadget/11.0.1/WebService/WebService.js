...
finesse.modules.SampleGadget = (function ($) {
    ...
    var makeWebServiceSuccess = function(rsp) {
        clientLogs.log ("makeWebServiceSuccess(): in method");
    ...
    clientLogs.log("makeWebServiceError():" + rsp);
    };
    ...
    return {
        ...
        mymakeRequest : function (url, handler, params) {
            ...
            clientLogs.log("mymakeRequest(): io.makeRequest to http://10.88.194.158:8080" + url);
        },
        ...
        myrestRequest : function (url, options) {
            ...
            clientLogs.log("myrestRequest(): In myrestRequest");
        ...
        makeWebService : function () {
            clientLogs.log("makeWebService(): in method");
        ...
        init : function () {
            ...
            clientLogs.init(gadgets.Hub, "WebServiceSampleGadget", finesse.gadget.Config);
