...
finesse.modules.SampleGadget = (function ($) {
    ...
    _activateTab = function (tabnum) {
        ...
        // Uncomment the line below if you want the page to automatically switch
        // to the gadget's tab (eg. Home, Manage Customer, etc.) when the workflow
        // pops.
        //containerServices.activateMyTab();
        //clientLogs.log("_activateTab(): Tab is visible");
    },
