...
-------------------------------------------------------------------------------
   ...
   The WorkflowScreenPop sample gadget is intended to serve as an example of
   popping a new tab for each WorkflowActionEvent received.

   This sample illustrates how to initialize the gadget, and to set up a handler
   for receiving the WorkflowActionEvent and placing the path in an iframe on a
   new tab in the gadget.
...
II. Requirements
-------------------------------------------------------------------------------
A valid configured Workflow (assigned to the agent's team) which will be
triggered by a WorkflowActionEvent
