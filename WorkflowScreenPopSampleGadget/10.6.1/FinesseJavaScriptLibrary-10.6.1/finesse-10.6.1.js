...
function (RestBase, Dialogs, ClientLog, Queues, WrapUpReasons, PhoneBooks, Workflows, MediaPropertiesLayout, Utilities) {
...
function () {
    ...
    //TODO: For now, we are preserving the dependency tree order to maintain structural integrity
    // Once verified, we can clean up all window object references and only assign finesse from here
