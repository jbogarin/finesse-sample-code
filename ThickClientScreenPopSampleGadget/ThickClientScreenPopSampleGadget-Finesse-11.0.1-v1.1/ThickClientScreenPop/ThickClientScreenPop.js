...
finesse.modules.SampleGadget = (function ($) {
    ...
    _handleWorkflowActionEvent =  function(workflowActionEvent) {
        ...
        clientLogs.log("_handleWorkflowActionEvent(): type= " + workflowActionEvent.getType());

        if (myhandledby === "OTHER" && mytype === "HTTP_REQUEST") {
            if (params.hasOwnProperty("path") === true)  {
                clientLogs.log("_handleWorkflowActionEvent(): About to pop thick client.  URL is: " + params.path.expandedValue );
                ...
                clientLogs.log("_handleWorkflowActionEvent(): Error in WorkflowActionExecutor : _handleWorkflowActionEvent(workflowActionEvent) - A thickclient action must have a Path.  Thick client path is missing.");
            }               
        }  // if myhandledby                
    };
    ...
    return {
        ...
        init : function () {
            ...
            clientLogs.init(gadgets.Hub, "ThickClientScreenpop", finesse.gadget.Config);
