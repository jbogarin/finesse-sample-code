 ...
 * using variables before they are defined.
 */
/*global $, _prefs,_uiMsg,ciscowidgets,dojo,finesse,gadgets,hostUrl, console, Handlebars */
...
(function (factory) {
    ...
    {
        finesse.utilities.Utilities = factory(finesse.Converter);
    }
}(function (Converter) {
    var Utilities = {
        ...
        */
         ...
         * @return {String}     [empty string or string itself]
         */
...
(function (factory) {
    ...
    window.finesse.clientservices.MasterTunnel = function (host, scheme) {
...
(function (factory) {
    ...
    window.finesse.clientservices.Topics = (function () {
    ...
    return window.finesse.clientservices.Topics;
}));
...
(function (factory) {
    ...
    window.finesse.clientservices.MasterPublisher = function (tunnel, hub) {
...
(function (factory) {
    ...
    window.finesse.clientservices.ClientServices = (function () {
        var
...
(function (factory) {
    ...
    var RestBase = FinesseBase.extend(/** @lends finesse.restservices.RestBase.prototype */{
         ...
         * @constructs finesse.restservices.RestBase
         */
...
(function (factory) {
    ...
    var RestCollectionBase = RestBase.extend({
...
(function (factory) {
    ...
    /**
        ...
        _isParticipantStateDroppable : function (part)
        {
          ...
          if (part.state === Dialog.States.ACTIVE || part.state === Dialog.States.ACCEPTED || part.state === Dialog.States.HELD)
          {
         ...
         * @returns {Object} Map of call variables; names mapped to values.  Examples are (DNIS, dialedNumber, callType, etc...)
         */
         ...
         *     The media address of the user performing the consult call.
         * @param {String} action
         *     The action string indicating the action to invoke on dialog.  Possible actions are defined in {@link finesse.restservices.Dialog.Actions}.
         * @param {Object} handlers
         *     An object containing the following (optional) handlers for the request:<ul>
         *         <li><b>success(rsp):</b> A callback function for a successful request to be invoked with the following
         *         response object as its only parameter:<ul>
    ...
    Dialog.Actions = /** @lends finesse.restservices.Dialog.Actions.prototype */ {
            ...
            /**
             * Initiates a Tranfer of a Dialog.
             */
            TRANSFER: "TRANSFER",
            /**
             * Initiates a Single-Step Tranfer of a Dialog.
             */
    ...
    Dialog.States = /** @lends finesse.restservices.Dialog.States.prototype */ {
       /**
         * Dialog or Participant on the Dialog is Alerting and waiting to be Answered.
         */
        ALERTING: "ALERTING",
        /**
         * Dialog or Participant on the Dialog is Initiating (eg. an outbound call was placed).
         */
        INITIATING: "INITIATING",
        /**
         * Dialog or Participant on the Dialog is Active.
         */
        ACTIVE: "ACTIVE",
        /**
         * Dialog or Participant has been Dropped from the Dialog.
         */
        DROPPED: "DROPPED",
        /**
         * Dialog or Participant on the Dialog is Held.
         */
        HELD: "HELD",
        /**
         * Dialog or Participant on the Dialog is Initiated (eg. an outbound call was placed and is ringing).
         */
        INITIATED: "INITIATED",
        /**
         * Dialog or Participant on the Dialog is Failed.
         */
        FAILED: "FAILED",
        /**
        ...
        INACTIVE: "INACTIVE",
        /**
         * Dialog or Participant on the Dialog is being Wrapped Up.
         */
        WRAP_UP: "WRAP_UP",
        /**
         * Dialog or Participant on the Dialog was Accepted.
         */
        ACCEPTED: "ACCEPTED",
        /**
         * @class Possible Dialog (or Participant) state constants.
         * @constructs
         */
        _fakeConstructor : function () {} // For JS Doc to work need a constructor so that the lends/constructs build the doc properly
    };
...
/** @private */
 (function (factory) {
	...
	var Queue = RestBase.extend(/** @lends finesse.restservices.Queue.prototype */{
		 ...
		 *     }
		 *  
	     * @constructs finesse.restservices.Queue
		 */
...
/** @private */
 (function (factory) {
	...
	var Queues = RestCollectionBase.extend(/** @lends finesse.restservices.Queues.prototype */{
         ...
         *         </ul></li>
         *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
         * @constructs finesse.restservices.Queues
         **/
        init: function (options) {
            this._super(options);           
        },
...
(function (factory) {
    ...
    {
        factory(finesse.restservices.RestBase, finesse.restservices.Contacts);
    } 
...
/**
 * @fileOverview JavaScript representation of the Finesse Workflow object.
 *
 * @name finesse.restservices.Workflow
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        // Define as an AMD module if possible
        define('restservices/Workflow',['restservices/RestBase'], factory);
    } else {
        /* Define using browser globals otherwise
         * Prevent multiple instantiations if the script is loaded twice
         */
    ...
    var Workflow = RestBase.extend({/** @lends finesse.restservices.Workflow.prototype */
         ...
         *         </ul></li>
         *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
         * @constructs finesse.restservices.Workflow
         **/
        init: function (options) {
            this._super(options);
        },
...
/**
* @fileOverview JavaScript representation of the Finesse workflows collection
* object which contains a list of workflow objects.
 *
 * @name finesse.restservices.workflows
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
(function (factory) {
    ...
    var Workflows = RestCollectionBase.extend(/** @lends finesse.restservices.Workflows.prototype */{
         ...
         *         </ul></li>
         *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
         * @constructs finesse.restservices.workflows
         **/
        init: function (options) {
            this._super(options);
        },
...
(function (factory) {
    ...
    var User = RestBase.extend(/** @lends finesse.restservices.User.prototype */{
        ...
        * @private
        ...
        /**
         * Getter for a Workflows collection object that is associated with User.
         * @param handlers
         * @returns {Workflows}
         *     A Workflows collection object.
         */
        getWorkflows: function (callbacks) {
            var options = callbacks || {};
            options.parentObj = this;
            this.isLoaded();
...
(function (factory) {
	...
	var TeamWrapUpReason = RestBase.extend(/** @lends finesse.restservices.TeamWrapUpReason.prototype */{
...
(function (factory) {
	...
	var TeamWrapUpReasons = RestCollectionBase.extend(/** @lends finesse.restservices.TeamWrapUpReasons.prototype */{
...
(function (factory) {
    ...
    var TeamPhoneBook = RestBase.extend(/** @lends finesse.restservices.TeamPhoneBook.prototype */{
...
(function (factory) {
    ...
    var TeamPhoneBooks = RestCollectionBase.extend(/** @lends finesse.restservices.TeamPhoneBooks.prototype */{
...
(function (factory) {
	...
	var LayoutConfig = RestBase.extend(/** @lends finesse.restservices.LayoutConfig.prototype */{
		...
		getLayoutxml: function () {
			this.isLoaded();
			var restResponse, domxml, layoutxml;
	        ...
	        layoutxml = (typeof window.XMLSerializer !== "undefined") ?
	            (new window.XMLSerializer()).serializeToString($(domxml).find("finesseLayout")[0]) :
	            $(domxml).find("finesseLayout")[0].xml;
...
/**
 * @fileOverview JavaScript representation of the Finesse LayoutConfig object for a Team.
 *
...
(function (factory) {
    ...
    var TeamLayoutConfig = RestBase.extend(/** @lends finesse.restservices.TeamLayoutConfig.prototype */{
...
/**
 * @fileOverview JavaScript representation of a TeamWorkflow.
 *
 * @name finesse.restservices.TeamWorkflow
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
(function (factory) {
    ...
    var TeamWorkflow = RestBase.extend(/** @lends finesse.restservices.TeamWorkflow.prototype */{
         ...
         *         </ul></li>
         *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
         * @constructs finesse.restservices.TeamWorkflow
         * @ignore
         **/
        init: function (options) {
            this._super(options);
...
/**
* @fileOverview JavaScript representation of the TeamWorkflows collection
* object which contains a list of TeamWorkflow objects.
 *
 * @name finesse.restservices.TeamWorkflows
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
(function (factory) {
    ...
    var TeamWorkflows = RestCollectionBase.extend(/** @lends finesse.restservices.TeamWorkflows.prototype */{
         ...
         *         </ul></li>
         *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
         * @constructs finesse.restservices.TeamWorkflows
         * @ignore
         **/
        init: function (options) {
            this._super(options);
...
(function (factory) {
    ...
    var Team = RestBase.extend(/** @lends finesse.restservices.Team.prototype */{
         ...
         * @returns {Users} Users collection of User objects
         */
...
(function (factory) {
    ...
    var Teams = RestCollectionBase.extend(/** @lends finesse.restservices.Teams.prototype */{
...
(function (factory) {
    ...
    var SystemInfo = RestBase.extend(/** @lends finesse.restservices.SystemInfo.prototype */{
         ...
         *         </ul></li>
         *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
         * @constructs finesse.restservices.SystemInfo
         **/
        init: function (id, callbacks, restObj)
        {
            this._super(id, callbacks, restObj);
    ...
    var ClientLogger = ( function () { /** @lends finesse.cslogger.ClientLogger.prototype */
        ...
        */
        ...
        return {
             ...
             * 
             * @constructs finesse.cslogger.ClientLogger
             */
...
/**
 * @fileOverview JavaScript representation of the Finesse WorkflowActionEvent object.
 *
 * @name finesse.containerservices.WorkflowActionEvent
 * @requires finesse.FinesseBase
 */
...
(function (factory) {
    ...
    var WorkflowActionEvent = FinesseBase.extend(/** @lends finesse.containerservices.WorkflowActionEvent.prototype */{
         ...
         * 
         * @constructs finesse.containerservices.WorkflowActionEvent
         **/
        init: function () {
            this._super();
        },        
	     ...
	     * @returns {String} The type of the WorkflowAction.
	     */
	    getType: function () {
	        // escape nulls to empty string
	        return this._type || "";
 ...
 *     constructing Finesse API requests and consuming Finesse events.
 *
 * @name finesse.containerservices.ContainerServices
 * @requires OpenAjax, jQuery 1.5, finesse.utilities.Utilities
 */

/** The following comment is to prevent jslint errors about using variables before they are defined. */
/*global window:true, gadgets:true, publisher:true, define:true, finesse:true, console:true, _tabTracker:true, _workflowActionEventTracker:true, frameElement:true, $:true, parent:true, MockControl:true */
...
(function (factory) {
    ...
    _topicCallback = function (topic) {
        ...
        switch (topic)
        {
            ...
            case finesse.containerservices.ContainerServices.Topics.WORKFLOW_ACTION_EVENT:
                ...
                break;
            default:
                console.log("Error in ContainerServices : _topicCallback(topic) - Topic not recognized.");
    ...
    return {
         ...
         * @constructs finesse.containerservices.ContainerServices
         */
        ...
        /**
         * For use from within a gadget only. Reloads the current gadget
         */
        ...
        addHandler: function (topic, callback) {
			...
			try {	
				...
				if (topic === "tabVisible") {
		            console.log("WARNING - Using tabVisible as topic.  This is deprecated.  Use finesse.containerservices.ContainerServices.Topics.ACTIVE_TAB now!");
        ...
        /**
         * Removes a handler for the topic that was added for.
         * @param {String} topic
        ...
        /**
         * Make a request to the check the current tab.  The 
...
(function (factory) {
        ...
        (function () {
            ...
            */
            ...
            require(['restservices/Users',
                     ...
                     'containerservices/ContainerServices'], function() {
                // Do nothing                
            });
        }.bind(this)());
    }
    ...
    if (gadgets.Prefs) {
        ...
        authString = finesse.utilities.Utilities.getCookie("authorization");
