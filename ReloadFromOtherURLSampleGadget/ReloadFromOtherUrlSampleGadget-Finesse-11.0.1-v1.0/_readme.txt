...
-------------------------------------------------------------------------------
   ...
   The Reload Gadget From Other Url sample gadget is intended to serve as an
   example of using the ContainerServices method reloadMyGadgetFromUrl in order
   to reload a gadget from a url different than the one specified in the layout.
   
   This sample illustrates how to initialize the gadget and create a button, which
   when clicked, will reload a gadget from the url specified in the javascript.
