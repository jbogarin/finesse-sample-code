...
finesse.modules.SampleGadget = (function ($) {      
    ...
    return {
        ...
        init : function () {
            ...
            clientLogs.init(gadgets.Hub, "CUIC", finesse.gadget.Config);
            
            // add code to handle tab clicked
            containerServices = finesse.containerservices.ContainerServices.init();
            containerServices.addHandler(finesse.containerservices.ContainerServices.Topics.ACTIVE_TAB, function() {
                clientLogs.log("init(): Gadget is now visible"); 
                 
                if ($("#cuic").length) {
                    // only modify the html if we haven't done it before
                    clientLogs.log("init(): Gadget html already=" + $("#cuic").html()); 
                } else {
                    var html = '';
                    ...
                    $("#agentout").html(html);
                    clientLogs.log("init(): Set html to=" + $("#cuic").html()); 
