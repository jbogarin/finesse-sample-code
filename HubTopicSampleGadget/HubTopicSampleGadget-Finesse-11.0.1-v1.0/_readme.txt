...
-------------------------------------------------------------------------------
   ...
   The SampleGadget_HubTopic sample gadget is intended to serve as an example
   of using the gadgets.hub.publish and gadgets.hub.subscribe which are part
   of the OpenSocial Specification.
   (http://opensocial-resources.googlecode.com/svn/spec/trunk/Core-Gadget.xml#gadgets.io.ContentType )
